...
import 'additional_screen_controller.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const YMargin(50),
                  authField(model.passwordController, false, "Enter a password"),
                  const YMargin(20),
                  authField(model.confirmPasswordController, true, "Confirm password"),
                  const YMargin(50),
                  SizedBox(
                    height: 50,
